...
angular.module('eventosSGEM')
  .controller('MainCtrl', ['$scope','$state','dataFactory','$timeout', 'sharedProperties','TenantLoader','$stateParams','dataTenant',
                                     function ($scope, $state, dataFactory,$timeout,sharedProperties,TenantLoader,$stateParams,dataTenant) {
